 ...
 *
 * HTML: <span data-user="admin" data-domain="example.com" class="protectEmails" />
 * CSS: .protectEmails:after { content: attr(data-user) '@' attr(data-domain); }
 * JavaScript: $('span').filter('.protectEmails').protectEmails();
 *
 */
;(function($){
	/**
